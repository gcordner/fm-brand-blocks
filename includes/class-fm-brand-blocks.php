...
class Fm_Brand_Blocks {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Fm_Brand_Blocks_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'FM_BRAND_BLOCKS_VERSION' ) ) {
			$this->version = FM_BRAND_BLOCKS_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'fm-brand-blocks';
	 ...
	 *
	 * - Fm_Brand_Blocks_Loader. Orchestrates the hooks of the plugin.
	 * - Fm_Brand_Blocks_i18n. Defines internationalization functionality.
	 * - Fm_Brand_Blocks_Admin. Defines all hooks for the admin area.
	 * - Fm_Brand_Blocks_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Fm_Brand_Blocks_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Fm_Brand_Blocks_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Fm_Brand_Blocks_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Fm_Brand_Blocks_Loader    Orchestrates the hooks of the plugin.
	 */
